...
public final class OptionGroupUI extends MigPanel
    implements OptionUpdater, TreeSelectionListener, OptionOneUI {
    ...
    public OptionGroupUI(GUI gui, OptionGroup group, boolean editable) {
        ...
        tree = new JTree(treeModel) {
				...
				public String convertone(Object value) {
					return converttoneone(value);
				}
				public String converttoneone(Object value) {
    ...
    public void valueChanged(TreeSelectionEvent event) {
        valueChangeone(event);
    }

	public void valueChangeone(TreeSelectionEvent event) {
    ...
    private void addOptionUI(Option option, boolean editable) {
        addOptiononeUI(option, editable);
    }

	public void addOptiononeUI(Option option, boolean editable) {
